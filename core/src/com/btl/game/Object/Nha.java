...
public class Nha extends Actor {
    ...
    private int vt;
    public  Nha(PlayScreen screen, float x, float y){
        ...
        textureTree.add(new TextureRegion(screen.getAtlas().findRegion("nha2"),100,0,202,105));
        textureTree.add(new TextureRegion(screen.getAtlas().findRegion("nha2"),100,0,100,105));
